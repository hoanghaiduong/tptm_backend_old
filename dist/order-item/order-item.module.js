...
let OrderItemModule = OrderItemModule_1 = class OrderItemModule {
};
OrderItemModule = OrderItemModule_1 = __decorate([
    (0, common_1.Module)({
        ...
        exports: [OrderItemModule_1, typeorm_1.TypeOrmModule]
    })
], OrderItemModule);
